...
const AboutMe = () => {
  return (
    <div className="justify-between m-5 mt-32 md:mt-3 md:flex">
      <div className="-mt-8 right-44 absolute w-2/5 h-2/5 md:bg-[#4FFFBF] rounded-3xl"></div>
      <div className="flex flex-col text-white md:ml-14 place-content-center">
        <h1 className="mb-10 text-6xl font-bold text-left md:text-7xl">
          Sobre Mí
        </h1>
        <p className="max-w-2xl mb-5 text-lg font-normal leading-normal">
      ...
      <div className="md:relative h-screen w-full md:m-0 md:w-1/2 p-10 bg-[#2F2F2F] rounded-3xl overflow-auto md:rounded-l-3xl max-h-full">
        ...
        <div className="items-center justify-between py-10 font-medium text-white md:text-center md:flex md:flex-wrap">
          <div className="w-24 h-24">
            <img src={mySQL} alt="Tecnologías" />
            <p>MySQL</p>
          </div>

          <span>
            <img src={mongoDB} alt="Tecnologías" className="h-12 w-15" />
            <p>MongoDB</p>
          </span>

          <span>
            <img src={postgreSQL} alt="Tecnologías" className="w-20 h-20" />
            <p>PostgreSQL</p>
          </span>
        </div>
        <h1 className="mb-8 text-2xl font-semibold leading-loose text-gray-700 dark:text-gray-300 md:text-4xl">
